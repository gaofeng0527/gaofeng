...
public class WxMenuController implements WxMpMenuService {
	...
	public String menuCreateSample() throws WxErrorException {
		...
		button1.setName("我要报装");
		button1.setUrl("http://gaof.edu-edu.com/gaofeng/open/install/redirect");
		WxMenuButton button2 = new WxMenuButton();
		button2.setType(MenuButtonType.VIEW);
		button2.setName("个人中心");
		button2.setUrl("http://gaof.edu-edu.com/gaofeng/open/admin/redirect");
		...
		button31.setName("搜索");
		button31.setUrl("http://gaof.edu-edu.com/gaofeng/open/install/redirect");
